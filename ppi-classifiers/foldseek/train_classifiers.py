...
def extract_templates():
    """ This function is used to extract the template data from the .json files generated by
        generate_top_templates.py. The template data is then used to train the classifiers.
    """
